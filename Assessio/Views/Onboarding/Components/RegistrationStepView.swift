    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 12) {
                ...
                Text("To access Assessio, you need to be registered with a school. Please share the link below with your school administrator.")
                    .font(.body)
            ...
            .accessibilityLabel("School Registration. To access Assessio, you need to be registered with a school. Please share the link below with your school administrator.")
            .accessibilityAddTraits(.isHeader)
